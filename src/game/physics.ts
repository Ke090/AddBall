...
export class PhysicsWorld {
  ...
  constructor(settings?: GameplaySettings, random?: () => number) {
    ...
    // Parameter-less construction is retained for older tests and integrations; make its probability roll deterministic.
    this.random = random ?? (settings ? Math.random : () => 0);
